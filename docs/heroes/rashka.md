...
| Ⅳ | :ongoing: Until the end of Combat, when your selected [unit](../units/index.md) is attacked by a :ground_unit: or :flying_unit: [unit](../units/index.md), the attacker takes 1 :damage:. |
| Ⅵ | :ongoing: Until the end of Combat, when your selected [unit](../units/index.md) is attacked by a :ground_unit: or :flying_unit: [unit](../units/index.md), the attacker takes 1 :damage:.<br><br>This effect doubles for the [Efreet unit](../units/efreet.md). |
