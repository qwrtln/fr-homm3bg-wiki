...
___
<p style="text-align: center;" markdown>:ongoing: During this Combat, neither player can use the :morale_positive: token or reroll [Attack dice](../keywords/dice.md#attack-die).<br><br>— OR —<br><br>:instant: +1 :empower:</p>
___
