...
___
<p style="text-align: center;" markdown>:ongoing: During this Combat, neither player can use the :positive_morale: token or reroll [Attack dice](../keywords/dice.md#attack-die).<br><br>— OR —<br><br>:instant: +1 :power:</p>
___
