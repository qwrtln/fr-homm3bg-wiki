...
___
<p style="text-align: center;" markdown>:effect_map: For every [Dwelling](../keywords/dwelling.md) you have, draw 1 corresponding [Neutral Unit](../units/index.md) card. You can [**Recruit**](../keywords/recruit.md) one of these units.<br><br>— OR —<br><br>:instant: Reroll a [die](../keywords/dice.md).</p>
___
