...
___
<p style="text-align: center;" markdown>:instant: Use this after the [Attack die](../keywords/dice.md#attack-die) roll. Ignore the [Attack die](../keywords/dice.md#attack-die) and any additional effects it triggered.<br><br>— OR —<br><br>:instant: +1 :defense:</p>
___
