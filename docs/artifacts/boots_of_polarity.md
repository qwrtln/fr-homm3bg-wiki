...
___
<p style="text-align: center;" markdown>:instant: Play this card after an enemy casts a [spell](../spells/index.md). Roll 2 [Attack dice](../keywords/dice.md#attack-die) and choose one. On a "+1 ", ignore the [:spell:](../spells/index.md) effect.<br><br>— OR —<br><br>:activation: Remove 1 :ongoing: effect.</p>
___
