...
___
<p style="text-align: center;" markdown>:ongoing: When casting a [:spellpower:](../spells/index.md) from the [School of Air Magic](../spells/school_of_air_magic.md), double the :empower: used for this [spell](../spells/index.md).<br><br>— OR —<br><br>:instant: When casting a [Air Magic :spellpower:](../spells/school_of_air_magic.md), Remove this card to gain +5 :empower:.</p>
___
