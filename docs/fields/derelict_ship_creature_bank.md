...
![Derelict Ship Creature Bank](../assets/locations-derelict_ship.webp){ width="475" align=right }
...
| Units | Reward | Extra |
| :--- | :--- | :--- |
| 4x&nbsp;[Water&nbsp;Elementals](../units/water_elementals.md#derelict-ship) | [:positive_morale:](../keywords/morale.md#positive) and 7 :gold:. | 2 :gold: for every Stacked unit and [**Search(X)**](../keywords/search.md) the [Spell](../spells/index.md) deck, where X is the number of Stacked units. |
