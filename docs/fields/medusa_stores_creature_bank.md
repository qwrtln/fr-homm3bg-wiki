# Medusa Stores (Creature Bank)

<figure markdown="span">

![Medusa Stores Creature Bank](../assets/locations-medusa_stores.webp){ width="475" align=right }
...
| Units | Reward | Extra |
| :--- | :--- | :--- |
| 4x&nbsp;[Medusas](../units/medusas.md) | 6 :gold: and 1 :valuables:. | 3 :gold: or 1 :valuables: for every Stacked unit. |
