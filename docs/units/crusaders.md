...
| Abilities | - | :unit_attack: You can reroll every "0" on this unit's [Attack die](../keywords/dice.md#attack-die). | :unit_passive: During any attack, roll 2 [Attack dice](../keywords/dice.md#attack-die) and resolve the higher outcome. |
...
- **Pack and Neutral** - The [Attack die](../keywords/dice.md#attack-die) may be rerolled until the number on the die no longer equals "0".
