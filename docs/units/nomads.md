...
| :initiative: | 7 |
| Cost | 10 :gold: |
| Abilities | :map_effect: At the end of your turn, move your [Hero's](../heroes/index.md) model to an adjacent empty field. |
...
- After using the :map_effect:, the Nomads are not put away, but stay in the player's unit deck.
