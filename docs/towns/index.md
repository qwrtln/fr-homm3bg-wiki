...
Towns have a multitude of buildings that can be built there.  Some of them have the same functionality across all factions, and provide faction-specific effects.
