...
| :--- | ---: | :---: |
| City Hall | 10 :gold:<br>3 :building_materials:<br>0 :valuables: | At the beginning of each Resource round, choose:<br>:instant:️ 4 :gold: for this round.<br><br>— OR —<br><br>:instant: **Search(3)** [:spellpower:](../spells/index.md) |
...
| Magic University | 6 :gold:<br>3 :building_materials:<br>0 :valuables: | Once per round, instead of **Searching** the :spellpower: deck, choose a [School of Magic](../spells/index.md) and discard cards from the top of the [Spell](../spells/index.md) deck until you find a [spell](../spells/index.md) from the chosen school. Take the spell into your hand. |
