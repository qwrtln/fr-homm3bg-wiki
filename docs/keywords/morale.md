...
Here is a quick reference of what happens to the player's morale depending on what their starting morale was.
...
- Reroll any [Die](dice.md) you have thrown.
...
A Negative Morale Token cannot be spent to perform any action.  Players can only get rid of it by gaining a [Positive Morale Token](morale.md#positive) or another Negative Morale Token.  Gaining a second Negative Morale Token will result in the player having to discard their hand of cards the next time they would end their Turn.
