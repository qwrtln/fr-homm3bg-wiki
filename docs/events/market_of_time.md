...
___
<p style="text-align: center;" markdown>**Each player chooses one option:** <br>Discard as many cards as you want, then draw new cards up to your :hand_limit: +2. Remove any number of [Ability](../abilities/index.md) or [Spell](../spells/index.md) cards from your hand. For every two cards removed this way, you can perform **Search (2)** the [Artifact](../artifacts/index.md) deck.<br><br>— OR —<br><br>Leave and gain nothing.</p>
___
