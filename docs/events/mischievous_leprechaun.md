...
___
<p style="text-align: center;" markdown>Pool 2 [:treasure:](../keywords/dice.md#treasure-die) and 2 [:resource_die:](../keywords/dice.md#resource-die), roll them, and put them within all players' reach. Starting from the player who drew this event, each player rolls 1 [:treasure:](../keywords/dice.md#treasure-die) and 1 [:resource_die:](../keywords/dice.md#resource-die). If they can match any of the pool's rolls, they may take one matching die from the pool and resolve its effects.</p>
___
