...
___
<p style="text-align: center;" markdown>:instant: When your \* [unit](../units/index.md) is about to be targeted or damaged by a [:spell:](../spells/index.md), choose a new target for that [:spell:](../spells/index.md).<br><br>:power: 0 ➣ \*:bronze:<br>:power: 1 ➣ \*:bronze: or :silver:<br>:power: 2 ➣ \*:bronze: or :silver: or :golden:<br><br>— OR —<br><br>:instant: +1 :power:</p>
___
