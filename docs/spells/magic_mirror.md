...
___
<p style="text-align: center;" markdown>:instant: When your \* [unit](../units/index.md) is about to be targeted or damaged by a [:spell:](../spells/index.md), choose a new target for that [:spell:](../spells/index.md).<br><br>:power: 0 ➣ \*:bronze_tier:<br>:power: 1 ➣ \*:bronze_tier: or :silver_tier:<br>:power: 2 ➣ \*:bronze_tier: or :silver_tier: or :gold_tier:<br><br>— OR —<br><br>:instant: +1 :power:</p>
___
