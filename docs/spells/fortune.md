...
___
<p style="text-align: center;" markdown>:instant: Reroll one [Treasure](../keywords/dice.md#treasure-die), [Resource](../keywords/dice.md#resource-die), or [Attack die](../keywords/dice.md#attack-die) \*. Resolve the result of your choice<br><br>:power: 0 ➣ \*once<br>:power: 1 ➣ \*twice<br>:power: 2 ➣ \*3 times<br><br>— OR —<br><br>:instant: +1 :power:</p>
___
